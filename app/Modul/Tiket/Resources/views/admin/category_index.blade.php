...
<div style="display: grid; grid-template-columns: 350px 1fr; gap: 25px;">
    ...
    <div class="card">
        ...
        <form action="/admin/tiket/kategori" method="POST">
            ...
            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">Slug <small style="color:#94a3b8; font-weight:400;">(otomatis / bisa diubah)</small></label>
                <input type="text" name="slug" id="tambah_slug" placeholder="auto-generate dari nama" style="width: 100%; padding: 10px; border: 1px solid #e2e8f0; border-radius: 8px; font-family: monospace; font-size: 0.875rem;">
            </div>
        ...
        <div style="overflow-x: auto;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                        ...
                        <td style="padding: 12px;">
                            <div style="display: flex; gap: 5px;">
                                ...
                                <form action="/admin/tiket/kategori/hapus/{{ $cat->id }}" method="POST" onsubmit="return confirm('Hapus kategori ini?')">
                                    @csrf
                                    <button type="submit" style="border: none; background: #fef2f2; color: #ef4444; width: 28px; height: 28px; border-radius: 6px; cursor: pointer;" title="Hapus">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" style="padding: 30px; text-align: center; color: #94a3b8;">Belum ada kategori.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <form id="formEdit" action="" method="POST">
            ...
            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">
                    Slug <small style="color:#94a3b8; font-weight:400;">(otomatis / bisa diubah)</small>
                </label>
