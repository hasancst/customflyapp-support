...
@section('judul', 'Tambah Slideshow')
...
<div class="card" style="max-width: 800px;">
    ...
    <form action="/admin/slideshow/tambah" method="POST" enctype="multipart/form-data" style="margin-top: 25px;">
        @csrf
        <div class="form-group" style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 600;">Judul</label>
            <input type="text" name="judul" required style="width: 100%;" placeholder="Masukkan judul slide">
        </div>
        
        <div class="form-group" style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 600;">Deskripsi</label>
            <textarea name="deskripsi" style="width: 100%; height: 80px;" placeholder="Masukkan deskripsi singkat"></textarea>
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="form-group" style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">Badge 1 (Floating)</label>
                <input type="text" name="badge_1" placeholder="Contoh: UI/UX Design">
            </div>
            <div class="form-group" style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 600;">Badge 2 (Floating)</label>
                <input type="text" name="badge_2" placeholder="Contoh: Development">
            </div>
        </div>

        <div class="form-group" style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 8px; font-weight: 600;">Gambar (Rekomendasi: 1920x800)</label>
        ...
        <div class="form-group" style="margin-bottom: 20px;">
            ...
            <input type="number" name="urutan" value="0" style="width: 100%;">
        </div>

        <div style="display: flex; gap: 10px; margin-top: 30px;">
            <button type="submit" class="btn">Simpan Slideshow</button>
